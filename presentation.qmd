...
![](images/clipboard-3275579236.png){height="600px"}
...
`read_rds()` from the `readr` package (part of the `tidverse` meta package) reads an R dataframe which was generated in a separate R script.
...
<br>
Not shown:<br>The titles have been defined in the list object `plot_titles`
